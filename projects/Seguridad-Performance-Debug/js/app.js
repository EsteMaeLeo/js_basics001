...
function selectCriptomonedas(criptomonedas) {
  ...
  //delete previous add in the select options
  let options = criptomonedasSelect.getElementsByTagName("option");

  for (let i = options.length; i--; ) {
    criptomonedasSelect.removeChild(options[i]);
  }

  //compare with for
  const ini2 = performance.now();
  ...
  const ending2 = performance.now();
  console.log(ini2);
  console.log(ending2);
  console.log(ending2 - ini2);
}
